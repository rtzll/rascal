...
CREATE TABLE runs (
  ...
  issue_number INTEGER NOT NULL DEFAULT 0,
  pr_number INTEGER NOT NULL DEFAULT 0,
  response_target_repo TEXT NOT NULL DEFAULT '',
  response_target_issue_number INTEGER NOT NULL DEFAULT 0,
  response_target_requested_by TEXT NOT NULL DEFAULT '',
  response_target_trigger TEXT NOT NULL DEFAULT '',
  response_target_review_thread_id INTEGER NOT NULL DEFAULT 0,
  created_by_user_id TEXT NOT NULL DEFAULT '',
