...
CREATE INDEX idx_repositories_enabled ON repositories (enabled, full_name);
CREATE INDEX idx_repositories_webhook_key ON repositories (webhook_key);

CREATE TABLE repository_user_roles (
...
CREATE INDEX idx_repository_user_roles_user_id ON repository_user_roles (user_id, role);
