...
CREATE INDEX idx_run_pipelines_status_created ON run_pipelines (status, created_at ASC);

CREATE TABLE run_pipeline_phases (
...
CREATE INDEX idx_run_pipeline_phases_pipeline_order ON run_pipeline_phases (pipeline_id, phase_order ASC);
CREATE INDEX idx_run_pipeline_phases_run_id ON run_pipeline_phases (run_id);
...
CREATE INDEX idx_run_lineage_parent_phase ON run_lineage (parent_pipeline_id, phase_order ASC, child_index ASC);
